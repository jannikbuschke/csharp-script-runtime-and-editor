...
namespace scripting.Test
{
      ...
      : WebApplicationFactory<TEntryPoint> where TEntryPoint : class
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            //var cs = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=scripting-test;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            //var options = new DbContextOptionsBuilder { };
            //options.UseSqlServer(cs, options =>
            //{
            //    options.MigrationsAssembly("scripting.Core.SqlServer");
            //});
